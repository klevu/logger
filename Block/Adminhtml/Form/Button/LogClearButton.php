...
class LogClearButton extends Field
{
     ...
     * @var string
     */
    protected $_template = 'Klevu_Logger::form/button/log-clear.phtml';
    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        $element->setDataUsingMethod('comment', __(
            'By clicking on %1, the %2 file will be renamed with the current timestamp and a newly created file will be placed in the var/log directory.',
            $buttonLabel,
    ...
    {
        $buttonLabel = (string)__($this->buttonLabel);
